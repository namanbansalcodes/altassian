      ...
      {showLinkForm ? (
        <div className="flex items-center gap-1 px-1">
          <input
            ...
            aria-label="Link URL"
            autoFocus
            className="w-36 sm:w-44 md:w-48 px-2 py-1 text-xs bg-white/10 text-white rounded border border-white/20 outline-none focus:border-blue-400 placeholder-gray-400"
          />
          <button
            type="button"
            onClick={applyLink}
