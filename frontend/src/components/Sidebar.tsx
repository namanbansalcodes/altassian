...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 h-full bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 overflow-y-auto overscroll-y-contain scrollbar-thin shrink-0">
