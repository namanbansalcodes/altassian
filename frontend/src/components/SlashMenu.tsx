...
export default function SlashMenu({ editor }: SlashMenuProps) {
  ...
  return (
    <div
      ...
      className="absolute z-50 w-64 sm:w-72 max-w-[calc(100vw-2rem)] max-h-80 overflow-y-auto bg-white dark:bg-gray-900 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 py-1"
