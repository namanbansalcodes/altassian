...
export default function CreateSpace() {
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <form onSubmit={e => { e.preventDefault(); mutation.mutate() }} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-5">
