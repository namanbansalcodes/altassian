    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="md:col-span-1 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <div className={`divide-y divide-gray-100 dark:divide-gray-800 max-h-[40vh] md:max-h-[600px] overflow-y-auto overscroll-y-contain ${mobileListExpanded ? '' : 'hidden md:block'}`}>
            {versions?.map(v => (
              <button
                key={v.id}
                onClick={() => {
