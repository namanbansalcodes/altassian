        ...
        <section className="mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-24 md:py-32 grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3">
              <a href="/register" className="inline-flex items-center justify-center rounded-full bg-black text-white dark:bg-white dark:text-black px-5 py-3 text-sm font-semibold shadow hover:scale-[1.01] transition">Create free account</a>
              <a href="#demo" className="inline-flex items-center justify-center rounded-full border border-gray-300 dark:border-gray-700 px-5 py-3 text-sm font-semibold hover:bg-gray-50 dark:hover:bg-gray-900 transition">Watch demo</a>
            </div>
            <div className="mt-6 text-xs text-gray-500 dark:text-gray-400">Open source · Git-native · SSO ready</div>
          </div>
          <div className="relative overflow-hidden rounded-2xl isolate min-w-0">
            ...
            <div className="relative rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden shadow-xl bg-white/70 dark:bg-gray-950/60">
              <img src="/hero.png" alt="Altassian preview" className="w-full h-auto" loading="lazy" />
            </div>
          </div>
        </section>
