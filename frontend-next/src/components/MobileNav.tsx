    ...
    <>
      ...
      <header className="sticky top-0 z-20 bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-700 h-14 flex items-center px-3 sm:px-4 gap-2 sm:gap-4 shrink-0 safe-area-top">
        ...
        <button
          ...
          className="lg:hidden p-2.5 rounded-lg text-zinc-500 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-800 active:bg-zinc-200 dark:active:bg-zinc-700"
      ...
      >
        <div className="flex items-center justify-between h-14 px-4 border-b border-zinc-200 dark:border-zinc-700 shrink-0">
          ...
          <button
            onClick={() => setDrawerOpen(false)}
            className="p-2.5 rounded-lg text-zinc-500 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-800"
      ...
      <nav className="md:hidden fixed bottom-0 inset-x-0 z-30 bg-white dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-700 safe-area-bottom" aria-label="Mobile navigation">
