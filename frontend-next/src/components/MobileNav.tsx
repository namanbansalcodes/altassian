    ...
    <>
      ...
      <nav className="mobile-bottom-nav md:hidden fixed bottom-0 inset-x-0 z-30 bg-white dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-700 safe-area-bottom" aria-label="Mobile navigation">
        <div className="flex items-center justify-around h-14">
          <Link href="/" className="flex flex-col items-center justify-center gap-0.5 flex-1 h-full text-xs text-zinc-500 dark:text-zinc-400" aria-label="Home">
          ...
          <Link href="/spaces" className="flex flex-col items-center justify-center gap-0.5 flex-1 h-full text-xs text-zinc-500 dark:text-zinc-400" aria-label="Spaces">
          ...
          <Link href="/login" className="flex flex-col items-center justify-center gap-0.5 flex-1 h-full text-xs text-zinc-500 dark:text-zinc-400" aria-label="Login">
          ...
          <Link href="/register" className="flex flex-col items-center justify-center gap-0.5 flex-1 h-full text-xs text-zinc-500 dark:text-zinc-400" aria-label="Register">
