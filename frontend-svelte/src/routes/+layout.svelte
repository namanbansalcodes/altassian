...
<QueryClientProvider client={queryClient}>
  ...
  <nav class="mobile-bottom-nav md:hidden fixed bottom-0 inset-x-0 z-30 bg-white dark:bg-neutral-900 border-t border-neutral-300 dark:border-neutral-700 safe-area-bottom" aria-label="Mobile navigation">
    <div class="flex items-center justify-around h-14">
      <a href="/" class="flex flex-col items-center justify-center gap-0.5 flex-1 h-full text-xs text-neutral-500 dark:text-neutral-400" aria-label="Home">
      ...
      <a href="/spaces" class="flex flex-col items-center justify-center gap-0.5 flex-1 h-full text-xs text-neutral-500 dark:text-neutral-400" aria-label="Spaces">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
        <span class="nav-label">Spaces</span>
      </a>
      {#if $isAuthenticated}
        <button on:click={handleLogout} class="flex flex-col items-center justify-center gap-0.5 flex-1 h-full text-xs text-neutral-500 dark:text-neutral-400" aria-label="Logout">
      ...
      {:else}
        <a href="/login" class="flex flex-col items-center justify-center gap-0.5 flex-1 h-full text-xs text-neutral-500 dark:text-neutral-400" aria-label="Login">
        ...
        <a href="/register" class="flex flex-col items-center justify-center gap-0.5 flex-1 h-full text-xs text-neutral-500 dark:text-neutral-400" aria-label="Register">
