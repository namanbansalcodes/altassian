...
<div class="container mx-auto max-w-md px-4 sm:px-6 py-6 sm:py-10">
  ...
  <form on:submit|preventDefault={() => mutation.mutate()} class="space-y-3">
    <input
      class="w-full border border-neutral-300 dark:border-neutral-600 rounded px-3 py-2.5 bg-transparent text-base focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
    ...
    />
    <button
      class="w-full px-4 py-2.5 rounded bg-blue-600 text-white font-medium disabled:opacity-60 hover:bg-blue-700 active:bg-blue-800 transition-colors"
